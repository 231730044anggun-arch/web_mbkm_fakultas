...
<div class="card p-4 assessment-page">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div>
            <h6 class="assessment-section-title mb-1">Form Penilaian Dosen Pembimbing</h6>
    ...
    <div class="assessment-info mb-4">
        <div class="row g-3">
            ...
            <div class="col-md-4"><div class="text-muted small">Pembimbing Lapangan</div><div class="fw-semibold">{{ $pengajuan->pembimbingLapangan->nama_pembimbing ?? '-' }}</div></div>
    ...
    <form action="{{ route('dosen.penilaian.store', $pengajuan->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                @if($penilaian?->file_penilaian_formal_dosen)
                    <div class="mt-2"><a href="{{ route('dosen.penilaian.file', $pengajuan->id) }}" target="_blank" class="btn btn-sm btn-outline-secondary">Lihat File Saat Ini</a></div>
                @endif
            </div>
            <div class="col-12">
                <hr>
            ...
            @if($pengajuan->status_seminar === 'selesai')
                <div class="col-md-6"><label class="form-label fw-semibold">Nama Penguji <span class="text-muted small">(opsional)</span></label><input type="text" name="nama_penguji" class="form-control" value="{{ old('nama_penguji', $penilaian?->nama_penguji) }}"></div>
                <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm assessment-table">
                            ...
                            <tbody>
                                @foreach(\App\Models\Penilaian::laporanRubrik('dosen') as $name => [$label, $bobot])
                                    <tr>
                ...
                <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm assessment-table">
                            <thead class="table-light"><tr><th class="align-top" style="width:60px;">No</th><th class="align-top">Indikator</th><th class="align-top" style="width:90px;">Bobot</th><th class="align-top" style="width:160px;">Nilai</th></tr></thead>
                            <tbody>
                                @foreach(\App\Models\Penilaian::presentasiRubrik('dosen') as $name => [$label, $bobot])
                                    <tr>
                ...
                <div class="col-12"><label class="form-label fw-semibold">Catatan Seminar</label><textarea name="catatan_seminar" class="form-control" rows="2">{{ old('catatan_seminar', $penilaian?->catatan_seminar) }}</textarea></div>
            @else
                <div class="col-12">
            ...
            @endif
            <div class="col-12">
                <label class="form-label fw-semibold">Catatan Dosen Pembimbing</label>
        ...
        <div class="alert alert-info mt-4 mb-0 py-2 small">
            Nilai Tahap 1 Dosen Pembimbing: <strong>{{ $penilaian->nilai_tahap1_dosen !== null ? number_format($penilaian->nilai_tahap1_dosen, 2) : 'Belum tersedia' }}</strong>
            / Nilai Tahap 2 Dosen: <strong>{{ $penilaian->nilai_seminar_dosen !== null ? number_format($penilaian->nilai_seminar_dosen, 2) : 'Belum tersedia' }}</strong>
