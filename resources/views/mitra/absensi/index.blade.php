...
<div class="card p-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div><h6 class="fw-bold mb-1">Validasi Absensi</h6><div class="text-muted small">Hanya absensi mahasiswa yang magang di instansi Anda.</div></div>
        <form class="row g-2" method="GET" action="{{ route('mitra.absensi.index') }}">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle">
            <thead class="table-light"><tr><th>Mahasiswa</th><th>Tanggal</th><th>Jam</th><th>Keterangan</th><th>Bukti</th><th>Status</th><th>Catatan Mitra</th><th>Aksi</th></tr></thead>
            <tbody>
            ...
            @forelse($absensis as $absensi)
                <tr>
                    ...
                    <td><a href="{{ route('mitra.absensi.preview', $absensi->id) }}" target="_blank" class="btn btn-sm btn-outline-secondary">Lihat</a></td>
                    ...
                    <td style="min-width:260px">
                        <div class="d-flex flex-wrap gap-1 align-items-center">
                            ...
                            <form action="{{ route('mitra.absensi.validasi', $absensi->id) }}" method="POST" class="d-inline">
                                @csrf
                        ...
                        <div class="collapse mt-2" id="absensi-revisi-{{ $absensi->id }}">
                            <form action="{{ route('mitra.absensi.validasi', $absensi->id) }}" method="POST">
                                @csrf
