...
<div class="card p-4 assessment-page">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div>
            <h6 class="section-title mb-1">Daftar Penilaian Lapangan</h6>
    ...
    <div class="table-responsive" style="overflow-x:auto;">
        <table class="table table-hover assessment-table">
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="8" class="text-center text-muted py-4">Belum ada mahasiswa magang yang dapat dinilai.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
