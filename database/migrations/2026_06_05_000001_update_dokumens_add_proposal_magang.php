...
return new class extends Migration {
    ...
    {
        DB::statement("ALTER TABLE dokumens MODIFY jenis_dokumen ENUM('surat_permohonan','surat_diterima','laporan','surat_pengantar','surat_keterangan_magang','sk_magang','surat_seminar') NOT NULL");
    }
};
