...
class AbsensiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pembimbing.absensi.index', compact('absensis', 'pengajuans', 'rekaps', 'pembimbing'));
    }
    ...
    public function validasi(Request $request, AbsensiMagang $absensi)
    {
        ...
        if ($absensi->mahasiswa?->user) {
            Notifikasi::create([
                ...
                'judul' => $request->status === 'disetujui' ? 'Absensi Disetujui Pembimbing Lapangan' : 'Absensi Perlu Diperbaiki',
