...
{
    protected $fillable = [
        'mahasiswa_id', 'pengajuan_awal_id', 'jenis_pengajuan', 'periode_id', 'jenis_magang', 'jenis_mitra', 'mitra_id',
    ...
    public function pembimbingLapangan() { return $this->hasOne(PembimbingLapangan::class, 'pengajuan_id'); }
