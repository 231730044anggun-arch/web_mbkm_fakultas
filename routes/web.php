...
use App\Http\Controllers\Pembimbing\SeminarController as PembimbingSeminar;
...
Route::prefix('dosen')->middleware(['auth', 'role:dosen'])->name('dosen.')->group(function () {
    ...
    Route::get('/seminar/kelayakan/{kelayakan}', [DosenSeminar::class, 'show'])->name('seminar.show');
    Route::post('/seminar/kelayakan/{kelayakan}/validasi', [DosenSeminar::class, 'validasi'])->name('seminar.validasi');
...
Route::prefix('pembimbing-lapangan')->middleware(['auth', 'role:pembimbing_lapangan'])->name('pembimbing.')->group(function () {
    ...
    Route::get('/seminar', [PembimbingSeminar::class, 'index'])->name('seminar.index');
    Route::get('/seminar/kelayakan/{kelayakan}', [PembimbingSeminar::class, 'show'])->name('seminar.show');
    Route::post('/seminar/kelayakan/{kelayakan}/validasi', [PembimbingSeminar::class, 'validasi'])->name('seminar.validasi');
